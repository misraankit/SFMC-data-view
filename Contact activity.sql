...
from
				(
					...
					from [_Click] cl
							...
							inner join [Master] cm on cl.SubscriberKey = cm.EmailAddress /*Replace table Master with Data Extension you are using*/
					...
					from [_Open] o
							 ...
							 inner join [Master] cm on o.SubscriberKey = cm.EmailAddress /*Replace table Master with Data Extension you are using*/
					...
					on sn.SubscriberKey = s.SubscriberKey
								inner join [Master] cm on sn.SubscriberKey = cm.EmailAddress /*Replace table Master with Data Extension you are using*/
					...
					from [_bounce] bnc
								...
								inner join [Contact Master] cm on bnc.SubscriberKey = cm.EmailAddress /*Replace table Master with Data Extension you are using*/
	...
	Where t.[Email Name] = 'EmailName' /*Add the Name of the Email here*/
