...
from
				(
					...
					from [_Click] cl
							...
							inner join [Coach Nudge Group] cm on cl.SubscriberKey = cm.EmailAddress
					...
					from [_Open] o
							 ...
							 inner join [Coach Nudge Group] cm on o.SubscriberKey = cm.EmailAddress
					...
					on sn.SubscriberKey = s.SubscriberKey
								inner join [Coach Nudge Group] cm on sn.SubscriberKey = cm.EmailAddress
					...
					from [_bounce] bnc
								...
								inner join [Coach Nudge Group] cm on bnc.SubscriberKey = cm.EmailAddress
